...
func main() {
	m := GetPluginManager()
    dir:=flag.String("path","D:\\development\\GoProjects\\study-go\\interfaces\\testplugins","a string")
	plugin:=flag.String("pathFile","D:\\development\\GoProjects\\study-go\\interfaces\\testpluginsSingle\\singleplugin.txt","a string")
